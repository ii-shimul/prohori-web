...
export function AlertDetailView({ alert, backHref, outletHref, caseHref }: { alert: OperationsAlert; backHref: string; outletHref: string; caseHref?: string }) {
    ...
    <section aria-labelledby="alert-title" className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_20rem]">
        ...
        <aside className="space-y-4">
          ...
          <Card className="border border-border shadow-none"><CardHeader><CardTitle>Safe Next Step</CardTitle></CardHeader><CardContent><p className="text-sm font-medium">{alert.safeNextStep}</p></CardContent></Card>
        </aside>
      </div>
    </section>
  );
