  ...
  return (
    <form action={action} className="grid gap-3 rounded-xl border border-border bg-background p-4 lg:grid-cols-[repeat(6,minmax(0,1fr))_auto_auto]">
      <label className="min-w-0 space-y-1.5 text-sm font-medium">
        Provider
        <select autoComplete="off" className={selectClassName} defaultValue={filters.provider} name="provider">
      ...
      <label className="min-w-0 space-y-1.5 text-sm font-medium">
        Agent
        <select autoComplete="off" className={selectClassName} defaultValue={filters.agent} name="agent">
      ...
      <label className="min-w-0 space-y-1.5 text-sm font-medium">
        Area
        <select autoComplete="off" className={selectClassName} defaultValue={filters.area} name="area">
      ...
      <label className="min-w-0 space-y-1.5 text-sm font-medium">
        Time
        <select autoComplete="off" className={selectClassName} defaultValue={filters.time} name="time">
      ...
      <label className="min-w-0 space-y-1.5 text-sm font-medium">
        Risk
        <select autoComplete="off" className={selectClassName} defaultValue={filters.risk} name="risk">
      ...
      <label className="min-w-0 space-y-1.5 text-sm font-medium">
        Freshness
        <select autoComplete="off" className={selectClassName} defaultValue={filters.freshness} name="freshness">
